...
<div class="pricing-area pt-95 pt-sm-77 pb-100 pb-sm-80">
	<div class="container">
		...
		<div class="tab-content mt-35">
			<div id="monthly" class="tab-pane fade in show active">
				<div class="row pricing-carousel">
					...
					<div class="col-lg-4">
						<div class="pricing-table-single {{ $loop->index%2!=0 ?'highlight':'' }} wow fadeIn" data-wow-delay=".3s">
							...
							<div class="pricing-table-body">
								...
								@if (Auth::check())
								<a href="#" class="btn-common" data-toggle="modal" data-target="#exampleModal{{ $pakage->id }}"
					...
					<!-- Modal -->
					<div class="modal fade" id="exampleModal{{ $pakage->id }}" tabindex="-1" role="dialog"
		...
		<div class="row mt-5 pricing-container">
			<div class="col-lg-3">
				<div class="card">
					<div class="card-header pricing-header-1">
						<div class="d-flex">
							<h5 class="card-title text-light">STARTER</h5>
							<span class="position-absolute price-span text-light">$40</span>
						</div>
						<p class="text-light p-0 m-0">10 Positive reviews</p>
					</div>
					<div class="card-body">
						<ul class="list-sign">
							<li>10 five star ratings</li>
							<li>10 app installs</li>
							<li>100% Real users</li>
							<li>Delivery: 4-5 days</li>
						</ul>
						<form action="" class="pricing-form">
							<input type="text" placeholder="Your app URL">
			...
			<div class="col-lg-3">
				<div class="card">
					<div class="card-header pricing-header-2">
						<div class="d-flex">
							<h5 class="card-title text-light">STARTER</h5>
							<span class="position-absolute price-span text-light">$40</span>
						</div>
			...
			<div class="col-lg-3">
				<div class="card">
					<div class="card-header pricing-header-3">
						<div class="d-flex">
							<h5 class="card-title text-light">STARTER</h5>
							<span class="position-absolute price-span text-light">$40</span>
						</div>
			...
			<div class="col-lg-3">
				<div class="card">
					<div class="card-header pricing-header-4">
						<div class="d-flex">
							<h5 class="card-title text-light">STARTER</h5>
							<span class="position-absolute price-span text-light">$40</span>
						</div>
