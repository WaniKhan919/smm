    ...
    <div class="row banner-caption align-items-center">
      <div class="col-lg-5 col-md-6">
        ...
        <div class="wow fadeInUp" data-wow-delay=".4s">
          <h1 class="mb-20"><span>Strategy</span></h1>
        </div>
        <div class="wow fadeInUp" data-wow-delay=".5s">
          <p>Speak with a results specialist today to get started with SEO, PPC, social media, web design & more.</p>
        </div>
        <div class="video-play mt-50 wow fadeInUp" data-wow-delay=".6s">
          <a class="venobox play-btn" data-gall="gall-video" data-autoplay="true" data-vbtype="video"
            href="https://youtu.be/ScMzIvxBSi4"><img src="{{ asset('front_assets/images/icons/video-icon.png')}}" alt="" />How it works</a>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="section-title text-center mb-45 wow fadeInUp" data-wow-delay=".3s">
          <h2><span>About SEO Inc, Digital Marketing & SEO</span></h2>
          <p class="mt-15">Since 1997, Aseona Inc. has been one of the top search engine optimization companies in the
            world, having helped hundreds <br /> of companies grow their businesses as a result of our search engine
            optimization services.</p>
        </div>
      </div>
      <div class="col-lg-5 offset-lg-1">
        <ul class="list-none list-sign wow fadeInUp" data-wow-delay=".4s">
          <li>A SEO Company to Meet Today's Standards</li>
          <li>Digital Marketing Solutions for Tomorrow</li>
          <li>Much More than an SEO Company</li>
        </ul>
      </div>
      <div class="col-lg-6">
        <ul class="list-none list-sign wow fadeInUp" data-wow-delay=".5s">
          <li>Service Minded - Results Driven</li>
          <li>A Responsible, Green Company</li>
