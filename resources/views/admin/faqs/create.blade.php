          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.faqs.store') }}">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" placeholder="Question" name="question" value="{{ old('question') }}">
                  @error('question')
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" style="height: 100px" placeholder="Answer" name="answer" value="{{ old('answer') }}"></textarea>
                  @error('answer')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
